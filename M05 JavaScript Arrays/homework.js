...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   let suma = arrayOfNums.reduce((acc, cur) => {
      return acc += cur;
   }, 0);
   return suma;
}
...
function mesesDelAño(array) {
   ...
   // Tu código:
   let meses = array.filter((cur) => {
      return (cur === 'Enero' || cur === 'Marzo' || cur === 'Noviembre');
   });
